...
\newpage
   \begin{algorithm}[H]
       ...
       \If{$G$ is not bipartite}{
           ...
           \Return{$\mathcal{C}/(V-O)$ as delta or blocker of an extended odd hole minor}\;
       }
       ...
       \caption{Finding a delta or blocker of an extended odd hole minor}
   \end{algorithm}

   \begin{proposition}
       The algorithm works correctly in $\mathcal{O}(n^2)$ time.
       If it returns a proper dense minor, a certificate for this minor being dense can be calculted in $\mathcal{O}(n^2)$ time.
   \end{proposition}
